    ...
    Drupal.behaviors.druvito = {
        attach: function(context, settings) {
            ...
            function shareUrls(name) {
                ...
                var urlFacebook = "https://www.facebook.com/sharer/sharer.php?u=" + permalink + "&t=" + name
            ...
            $(document).ready(function($) {
                ...
                $("#views-exposed-form-informes-y-estudios-block-1").addClass("row");
                $(".form-item-field-informe-categoria-value").addClass("col-lg-6 col-md-12 col-sm-12 col-xs-12");
                $(".form-item-field-informe-ano2-value").addClass("col-lg-6 col-md-12 col-sm-12 col-xs-12");
