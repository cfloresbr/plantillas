	...
	function create_fragment$8(ctx) {
	  ...
	  return {
	    c() {
		  ...
		  attr(button, "class", "btn btn-secundario"); 
	    },
	    m(target, anchor) {
		  ...
		  if(ctx[5] == "Anterior"){
			  button.innerHTML = '<i class="fas fa-arrow-left fa-1x" aria-hidden="true"></i>&nbsp' + ctx[5];
		  }else if(ctx[5] == "Siguiente"){
			  button.innerHTML = ctx[5] + '&nbsp<i class="fas fa-arrow-right fa-1x" aria-hidden="true"></i>';
		  }
	...
	function create_fragment$7(ctx) {
	  ...
	  return {
	    c() {
			...
			// Set the class attribute for the footer
